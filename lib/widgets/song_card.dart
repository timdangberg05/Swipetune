...
class _GlassSongCardState extends State<GlassSongCard>
                          ...
                          child: Opacity(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _buildInfoRow(Icons.calendar_today, "Release",
                                    widget.track.releaseDate),
                                const SizedBox(height: 8),
                                _buildInfoRow(Icons.trending_up, "Popularity",
                                    "${widget.track.popularity}/100"),
                                const SizedBox(height: 8),
  ...
  Widget _coverFallback() => Container(
        ...
        child: const Center(
          child:
              Icon(Icons.music_note_rounded, size: 60, color: Colors.white38),
        ),
      );

  // InfoRow mit dezenter schwarzer Umrandung
